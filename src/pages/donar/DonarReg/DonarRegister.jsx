...
import Validation from "../DonarLogin/validation";
...
const DonarRegister=()=> {
    ...
    const submitForm= async(e) =>{
        ...
        await axios.post("http://localhost:8080/api/register", value, config)
    ...
    return (
        ...
        <div className="main-head">
            ...
            <label>Phone</label>
            <input type="number" name="phone" value={value.phone} onChange={handleChange} /><br />
            {errors.phone && <p className='error'>{errors.phone}</p>}

            <button id="#" onClick={submitForm}>Submit</button>
        </form>
        </div>
            </div>
        </div>
